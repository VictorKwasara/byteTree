...
export default function Home() {
	return (
		<Box className={styles.box}>
			...
			<Typography variant='h1' component='h2' align='center' p={2} m={2}>
			...
			<Button LinkComponent={Link} href="/actions" size='large' variant='contained' color='secondary' sx={{zIndex:500}}>
				Become A Farmer
			</Button>
		</Box>
	);
